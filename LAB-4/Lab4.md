...
**Topics Covered:** Dockerfile · .dockerignore · Tagging · Publishing
...
📸 **Screenshot – Dockerfile and project structure:**

![Dockerfile](../LAB-4/SCREENSHOTS/1.png)
...
📸 **Screenshot – .dockerignore file created:**

![.dockerignore file](../LAB-4/SCREENSHOTS/2.png)
...
![docker build](../LAB-4/SCREENSHOTS/3.png)

📸 **Screenshot – docker images listing:**

![docker images](../LAB-4/SCREENSHOTS/4.png)
...
📸 **Screenshot – image tagging commands:**

![tagging commands](../LAB-4/SCREENSHOTS/5.png)
...
![docker inspect](../LAB-4/SCREENSHOTS/6.png)
...
📸 **Screenshot – container running and curl output:**

![curl output](../LAB-4/SCREENSHOTS/7.png)
...
📸 **Screenshot – container stop/start/remove commands:**

![remove/stop](../LAB-4/SCREENSHOTS/8.png)
...
📸 **Screenshot – multi-stage build output:**

![build output](../LAB-4/SCREENSHOTS/9.png)

📸 **Screenshot – image size comparison:**

![size comparison](../LAB-4/SCREENSHOTS/10.png)
...
📸 **Screenshot – docker push output:**

![push output](../LAB-4/SCREENSHOTS/11.png)
...
📸 **Screenshot – docker pull and run from Docker Hub:**

![pull and run](../LAB-4/SCREENSHOTS/12.png)
